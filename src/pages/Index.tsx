...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <main className="pt-20 sm:pt-24 px-4 md:px-6 lg:px-8 overflow-x-hidden">
        <div className="max-w-7xl mx-auto">
          {/* Hero Section */}
          <section className="flex flex-col md:flex-row items-center justify-between py-8 md:py-12 lg:py-20">
            <div className="w-full md:w-1/2 md:pr-8 lg:pr-12 mb-8 md:mb-0">
              ...
              <FadeInSection direction="left" delay={600}>
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <button className="px-4 sm:px-6 py-3 bg-black text-white rounded-md hover:bg-black/90 transition-colors text-sm sm:text-base">
                    Download the app
                  </button>
                  <button className="px-4 sm:px-6 py-3 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors text-sm sm:text-base">
                    Learn more
                  </button>
                </div>
              </FadeInSection>
          ...
          <section className="py-10 sm:py-16 md:py-24">
            <FadeInSection>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 text-center">Explore trending content</h2>
            </FadeInSection>
            
            <FadeInSection delay={200}>
              <p className="text-sm sm:text-base text-gray-600 mb-8 sm:mb-12 text-center max-w-2xl mx-auto">
                Discover photos and videos from creators around the world
              </p>
            </FadeInSection>
            
            <ImageGrid images={images} className="mt-6 sm:mt-8" />
          </section>
          
          {/* Features Section */}
          <section className="py-10 sm:py-16 md:py-24">
            <FadeInSection>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-8 sm:mb-16 text-center">Why people love our platform</h2>
            </FadeInSection>
              ...
              {[
                ...
                <FadeInSection key={i} delay={feature.delay}>
                  <div className="glass-card rounded-xl p-4 sm:p-6 h-full">
                    <div className="h-10 sm:h-12 w-10 sm:w-12 bg-black text-white rounded-md flex items-center justify-center mb-4">
                      {i + 1}
                    </div>
          ...
          <section className="py-10 sm:py-16 md:py-24">
            <div className="relative rounded-xl sm:rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 px-4 sm:px-6 py-12 sm:py-16 md:py-24 md:px-12 text-center">
                <FadeInSection>
                ...
                <FadeInSection delay={400}>
                  <button className="px-6 py-3 bg-white text-gray-900 rounded-md hover:bg-gray-100 transition-colors text-sm sm:text-base">
                    Download now
                  </button>
                </FadeInSection>
              </div>
      ...
      <footer className="bg-white border-t border-gray-200 py-8 sm:py-12 px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-lg sm:text-xl font-semibold">Instagram</h2>
              <p className="text-sm sm:text-base text-gray-600 mt-2">Share your moments with the world</p>
            </div>
          ...
          <div className="border-t border-gray-200 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-gray-500 text-xs sm:text-sm">
